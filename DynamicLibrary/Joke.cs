...
namespace DynamicLibrary
{
    public static class Jokes
    {
        ...
        "Почему я не уступаю место бабушкам в автобусе? Потому что бабки это не главное.", "Худшая оценка в школе вампиров? Кол.", "На директора АвтоВАЗа хотели завести уголовное дело. Оно не завелось"};
